        ...
        <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
            ...
            <body>
                <div class="payroll-container">
                    ...
                    <form action="<c:url value='/payroll/personal'/>" method="post" class="search-form">
                        <div class="form-row">
                    ...
                    <table>
                        ...
                        <tbody>
                            <c:if test="${empty PersonalPayrolls}">
                                <tr>
                                    <td colspan="7" class="no-data">No payroll records found</td>
                                </tr>
                            </c:if>
                        ...
                        <nav class="pagination-nav">
                            <ul class="pagination">
                                <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
                                    <a class="page-link"
                                        href="<c:url value='/payroll/personal?page=${currentPage - 1}&itemsPerPage=${itemsPerPage}&month=${param.month}&year=${param.year}'/>">
                                        Previous
                                    </a>
                                </li>
