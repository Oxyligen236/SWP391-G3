...
<div class="container-fluid p-4">
    <div class="row mb-4">
        <div class="col-12">
            ...
            <p class="text-muted mb-0">Quick Access to HR Functions</p>
        </div>
    </div>
    ...
    <div class="admin-grid">
        ...
        <!-- Create User -->
        <div class="grid-item hover-card" onclick="window.parent.loadInFrame('${pageContext.request.contextPath}/user/create')">
            <div class="icon-box bg-soft-danger">
                <i class="uil uil-user-plus"></i>
            </div>
            <h5 class="grid-title"><i class="uil uil-users-alt me-2"></i>Create User</h5>
            <p class="grid-desc">Add new employee</p>
        </div>
