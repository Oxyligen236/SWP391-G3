...
<div class="container-fluid p-4">
    <div class="row mb-4">
        <div class="col-12">
            ...
            <p class="text-muted mb-0">Quick Access to Admin Functions</p>
        </div>
    </div>
    ...
    <div class="admin-grid">
        ...
        <div class="grid-item hover-card" onclick="window.parent.loadInFrame('${pageContext.request.contextPath}/account/view')">
            ...
            <h5 class="grid-title"><i class="uil uil-users-alt me-2"></i>Account List</h5>
            <p class="grid-desc">View all accounts</p>
        </div>
        ...
        <div class="grid-item hover-card" onclick="window.parent.loadInFrame('${pageContext.request.contextPath}/userlist')">
            ...
            <h5 class="grid-title"><i class="uil uil-users-alt me-2"></i>Create Account</h5>
            <p class="grid-desc">Add new account</p>
        </div>
        ...
        <div class="grid-item hover-card" onclick="window.parent.loadInFrame('${pageContext.request.contextPath}/myattendance')">
            ...
            <p class="grid-desc">View attendance records</p>
        </div>
    </div>
</div>
