            ...
            <nav id="sidebar" class="sidebar-wrapper">
                <div class="sidebar-content" data-simplebar style="height: calc(100% - 60px);">
                    ...
                    <ul class="sidebar-menu pt-3">
                        ...
                        <li class="sidebar-dropdown">
                            <a href="javascript:void(0)"><i class="uil uil-wheelchair me-2 d-inline-block"></i>CV</a>
                            <div class="sidebar-submenu">
                                <ul>
                                    <li><a href="#">Submit CV</a></li>
                                    <li><a href="#">View CV List</a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    ...
                                    <li><a href="#">View Contract List</a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    ...
                                    <li><a href="#">Company Payroll</a></li>
                                    <li><a href="#">Summary Company Payroll</a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="sidebar-dropdown">
                            <a href="javascript:void(0)"><i class="uil uil-flip-h me-2 d-inline-block"></i>Attendance</a>
                            <div class="sidebar-submenu">
                                <ul>
