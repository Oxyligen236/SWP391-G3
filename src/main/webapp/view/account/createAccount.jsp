...
<head>
    ...
    <style>
        ...
        .form-header h2 {
            font-size: 28px; font-weight: 600; color: #d63384;
            margin-bottom: 5px;
        }
        .form-header hr {
            width: 60px; border-top: 3px solid #d63384; margin: 0 auto;
        }
        ...
        .btn-create {
            background: linear-gradient(135deg, #d63384, #a71d5d); color: #fff; border: none;
        }
        .btn-create:hover {
            background: linear-gradient(135deg, #a71d5d, #730036); transform: translateY(-2px);
        }
        .btn-back {
            background: linear-gradient(135deg, #6c757d, #495057); color: #fff; border:none;
        }
        .btn-back:hover {
            background: linear-gradient(135deg, #495057, #343a40); transform: translateY(-2px);
        }
