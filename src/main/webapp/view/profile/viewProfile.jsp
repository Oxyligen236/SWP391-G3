        ...
        <div class="profile-card">
          ...
          <div class="profile-header">
            <div class="avatar-container">
              <img
                src="https://ui-avatars.com/api/?name=${user.fullname}&size=130&background=random&color=fff&bold=true"
                alt="Avatar"
                class="avatar"
              />
            </div>
          ...
          <div class="text-center mt-5">
            <a href="${pageContext.request.contextPath}/edit" class="btn-edit">
