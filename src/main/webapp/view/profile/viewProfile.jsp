                ...
                <div class="profile-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <div class="info-row">
                                <div class="info-label">
                                    <i class="fas fa-flag me-2"></i>Quốc tịch
                                </div>
                                <div class="info-value">
                                    <c:choose>
                                        <c:when test="${not empty user.nation}">
                                            ${user.nation}
                                        </c:when>
                                        <c:otherwise>
                                            <span class="text-muted fst-italic">Chưa cập nhật</span>
                        ...
                        <div class="col-md-6">
                            <div class="info-row">
                                <div class="info-label">
                                    <i class="fas fa-users me-2"></i>Dân tộc
                                </div>
                                <div class="info-value">
                                    <c:choose>
                                        <c:when test="${not empty user.ethnicity}">
                                            ${user.ethnicity}
                                        </c:when>
                                        <c:otherwise>
                                            <span class="text-muted fst-italic">Chưa cập nhật</span>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                                ...
                                <div class="info-value">
                                    <c:choose>
                                        <c:when test="${not empty user.departmentName}">
                                            <span
                                                class="badge bg-primary badge-custom">${user.departmentName}</span>
                                        </c:when>
                                        <c:otherwise>
                            ...
                            <div class="info-row">
                                <div class="info-label">
                                    <i class="fas fa-user-tag me-2"></i>Chức vụ
                                </div>
                                <div class="info-value">
                                    <c:choose>
                                        <c:when test="${not empty user.positionName}">
                                            <span
                                                class="badge bg-info badge-custom">${user.positionName}</span>
                                        </c:when>
                                        <c:otherwise>
                        ...
                        <div class="col-md-6">
                            <div class="info-row">
                                <div class="info-label">
                                    <i class="fas fa-shield-alt me-2"></i>Vai trò hệ thống
                                </div>
                                <div class="info-value">
                                    <c:choose>
                                        <c:when test="${not empty user.roleName}">
                                            <span
                                                class="badge bg-warning text-dark badge-custom">${user.roleName}</span>
                                        </c:when>
                                        <c:otherwise>
                                            <span class="text-muted fst-italic">Chưa gán quyền</span>
                                        </c:otherwise>
                                    </c:choose>
                                </div>
                            </div>
                            ...
                            <div class="info-row">
                                <div class="info-label">
                                    <i class="fas fa-graduation-cap me-2"></i>Bằng cấp
                                </div>
                                <div class="info-value">
                                    <c:choose>
                                        <c:when test="${not empty user.degreeName}">
                                            <span
                                                class="badge bg-secondary badge-custom">${user.degreeName}</span>
                                        </c:when>
                                        <c:otherwise>
                                            <span class="text-muted fst-italic">Chưa cập nhật</span>
                                        </c:otherwise>
